...
public final class Years<U extends IsoDateUnit>
    ...
    public static Years<IsoDateUnit> ofWeekBased(int years) {
        ...
        return new Years<>(years, CalendarUnit.weekBasedYears());
    ...
    public Years<U> abs() {
        ...
        return new Years<>(MathUtils.safeCast(Math.abs(value)), this.unit);
    ...
    public Years<U> inverse() {
        ...
        return new Years<>(MathUtils.safeNegate(this.amount), this.unit);
    ...
    public Years<U> plus(int amount) {
        ...
        long value = this.amount;
        return new Years<>(MathUtils.safeCast(value + amount), this.unit);
    ...
    public Years<U> plus(Years<U> years) {
        ...
        long value = this.amount;
        return new Years<>(MathUtils.safeCast(value + years.amount), this.unit);
    ...
    public Years<U> multipliedBy(int factor) {
        ...
        switch (factor) {
            ...
            case 1:
                return this;
            default:
                return new Years<>(MathUtils.safeMultiply(this.amount, factor), this.unit);
        }
