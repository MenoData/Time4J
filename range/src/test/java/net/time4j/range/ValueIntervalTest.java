...
public class ValueIntervalTest {
    ...
    public void delegateMethods() {
        ...
        assertThat(vi.contains(interval.getStart().getTemporal()), is(true));
        assertThat(vi.isAfter(interval.getStart().getTemporal()), is(false));
        assertThat(vi.isBefore(interval.getStart().getTemporal()), is(false));
