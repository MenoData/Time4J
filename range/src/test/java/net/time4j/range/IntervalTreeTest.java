...
public class IntervalTreeTest {
    ...
    public void visitor() {
        ...
        final List<TimestampInterval> result = new ArrayList<TimestampInterval>();
        tree.accept(
            new IntervalTree.Visitor<TimestampInterval>() {
                @Override
                public boolean visited(TimestampInterval interval) {
                    result.add(interval);
                    return false;
                }
            }
    ...
    public void onTraditionalTimeLine() {
        ...
        assertThat(
            tree.findIntersections(i3).isEmpty(),
            is(true));
        assertThat(
    ...
    public void forEach() {
        ...
        List<DateInterval> coll1 = new ArrayList<DateInterval>();
        List<DateInterval> coll2 = new ArrayList<DateInterval>();
    ...
    @Test
    public void isEmpty() {
        Collection<DateInterval> empty = Collections.emptyList();
        IntervalTree<PlainDate, DateInterval> tree = IntervalTree.onDateAxis(empty);
