 ...
 *
 * <ol>
 *  <li>Leere Dauer =&gt; Die Methode liefert einfach nur den
 *  angegebenen Zeitpunkt unver&auml;ndert zur&uuml;ck. </li>
...
public abstract class AbstractDuration<U extends ChronoUnit>
    ...
    @Override
    public boolean contains(@Nullable ChronoUnit unit) {
    ...
    @Override
    public long getPartialAmount(@Nullable ChronoUnit unit) {
     ...
     * @param   time    Referenzzeitpunkt, zu dem diese Dauer zu
     *                  addieren ist
     * @return  neuer Zeitpunkt als Additionsergebnis
     * @see     TimePoint#plus(TimeSpan) TimePoint.plus(this)
     */
    @Override
     ...
     *
     * @param   <T> generischer Zeitpunkttyp
     * @param   time    Referenzzeitpunkt, von dem diese Dauer zu
     *                  subtrahieren ist
     * @return  neuer Zeitpunkt als Subtraktionsergebnis
     * @see     TimePoint#minus(TimeSpan) TimePoint.minus(this)
     */
    @Override
    ...
    private static <U, T> long getFactor(
        TimeAxis<U, T> engine,
        U unit1,
        U unit2
    ) {
