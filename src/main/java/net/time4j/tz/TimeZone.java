...
public abstract class TimeZone
     ...
     *
     * @return  unver&auml;nderliche und lexikalisch sortierte Liste der
     *          unterst&uuml;tzten Zeitzonen-IDs
     */
     ...
     *
     * @param   tzid    Zeitzonen-ID
     * @return  gesuchte Zeitzone
     ...
     * Ausnahme. </p>
     *
     * @param   tzid        bevorzugte Zeitzone
     * @param   fallback    alternative Zeitzone
     * @return  Zeitzone
     */
     ...
     *
     * @param   ut      UT-Weltzeit
     * @return  Verschiebung in Sekunden, die addiert zur POSIX-Zeit die lokale
     *          Zeit ergibt
     ...
     * @return  Verschiebung in Sekunden, die subtrahiert von der lokalen
     *          Zeit die POSIX-Zeit ergibt
     * @see     java.util.TimeZone#getOffset(int, int, int, int, int, int)
     * @see     net.time4j.TransitionStrategy#PUSH_FORWARD
     */
     ...
     * @param   localDate   lokales Datum
     * @param   localTime   lokale Uhrzeit
     * @return  {@code true} wenn der lokale Zeitpunkt nicht definiert ist,
     *          sonst {@code false}
     */
     ...
     *
     * @param   ut      UT-Weltzeit
     * @return  {@code true} wenn Sommerzeit vorliegt, sonst {@code false}
     ...
     *
     * @return  {@code TransitionHistory} oder {@code null} wenn au&szlig;er
     *          der Klasse {@code java.util.TimeZone} kein besserer
     *          {@code Provider} gefunden werden kann
     */
    @Nullable
    public abstract TransitionHistory getHistory();

    /**
     * <p>Ermittelt den anzuzeigenden Namen der Zeitzone in Kurzform. </p>
     *
     * <p>Ist der Zeitzonenname nicht ermittelbar, wird die ID der Zeitzone
     * geliefert. </p>
     *
     * @param   daylightSaving  Liegt Sommerzeit vor?
     * @param   locale          gew&uuml;nschte Sprache
     * @return  kurzer Zeitzonenname f&uuml;r Anzeigezwecke
    ...
    public String getNameAbbreviated(
        ...
        return this.getName(daylightSaving, true, locale);

    }

    /**
     * <p>Ermittelt den anzuzeigenden Namen der Zeitzone in Langform. </p>
     *
     * <p>Ist der Zeitzonenname nicht ermittelbar, wird die ID der Zeitzone
     * geliefert. </p>
     *
     * @param   daylightSaving  Liegt Sommerzeit vor?
     * @param   locale          gew&uuml;nschte Sprache
     * @return  langer Zeitzonenname f&uuml;r Anzeigezwecke
     * @see     java.util.TimeZone#getDisplayName(boolean,int,Locale)
     * @see     Locale#getDefault()
     * @see     #getID()
     */
    public String getNameFull(
        ...
        return this.getName(daylightSaving, false, locale);
    ...
    /**
     * <p>Liefert den Zeitzonennamen. </p>
     *
     * @param   daylightSaving      Sommerzeitnamen verwenden?
     * @param   abbreviated         Abk&uuml;rzung verwenden?
     * @param   locale              Spracheinstellung
     * @return  lokalisierter Zeitzonenname
     */
    String getName(
        boolean daylightSaving,
        boolean abbreviated,
    ...
    public interface Provider {
         ...
         * <p>Liefert alle verf&uuml;gbaren Zeitzonenkennungen. </p>
         *
         * @return  unver&auml;nderliches Set
         ...
         *
         * @return  Abbildung aller Zonen-Aliases auf ihre kanonischen IDs
         */
         ...
         *
         * @param   zoneID          Zonen-ID (z.B. &quot;Europe/Berlin&quot;)
         * @param   fallback        Ausweichoption zur&uuml;ckgeben, wenn die
         *                          Zonen-ID auch per Alias nicht vorhanden ist?
         * @return  Zeitzonenhistorie oder {@code null}, wenn keine Daten
         *          existieren
         * @throws  IllegalStateException wenn die Zeitzonendatenbank defekt ist
         * @see     #getAvailableIDs()
         * @see     #getAliases()
         ...
         *
         * @return  String, der zum Beispiel auf einen URI verweist oder eine
         *          leere Zeichenkette, wenn unbekannt
         */
        String getLocation();
         ...
         *
         * @return  String (zum Beispiel &quot;2011n&quot;) oder eine leere
         *          Zeichenkette, wenn unbekannt
         */
        String getVersion();
    ...
    public static class Cache {
         ...
         *
         * @param   active  {@code true} wenn der Cache wirksam sein soll,
         *                  sonst {@code false}
         */
         ...
         *
         * @param   minimumCacheSize    neue Mindestgr&ouml;&szlig;e des Cache
         * @throws  IllegalArgumentException wenn das Argument negativ ist
         */
