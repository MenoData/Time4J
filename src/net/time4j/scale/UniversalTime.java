...
public interface UniversalTime
    ...
    /**
     * <p>Globales, und serialisierbares {@code Comparator}-Singleton zum
     * Vergleich von beliebigen {@code UniversalTime}-Zeitpunkten. </p>
     *
     * <p>Das Objekt ist zustandslos und daher <i>thread-safe</i>. Der
     * Vergleich schlie&szlig;t m&ouml;gliche Schaltsekunden immer ein. </p>
     */
    static final Comparator<UniversalTime> COMPARATOR = new UtcComparator();

    //~ Methoden ----------------------------------------------------------

    /**
     * <p>Liefert die Zeitkoordinate in Sekunden relativ zur UTC-Epoche
     * [1972-01-01T00:00:00Z] in der UTC-Zeitzone. </p>
     *
     * <p>Sofern UTC-Schaltsekunden in der Konfiguration unterst&uuml;tzt
     * werden, wird die UTC-Zeit geliefert, sonst eine POSIX-&auml;hnliche
     * Zeit relativ zur UTC-Epoche, die zwei Jahre nach der UNIX-Epoche
     * liegt. </p>
     *
     * @return  Anzahl der Sekunden relativ zur UTC-Epoche (Nullpunkt der
     *          UTC-Weltzeitlinie = [1972-01-01T00:00:00Z]) inklusive eventuell
     *          vorhandener Schaltsekunden in der UTC-Zeitzone (Greenwich)
     ...
     *
     * @return  {@code true} wenn diese Instanz eine positive Schaltsekunde
     *          repr&auml;sentiert, sonst {@code false}
     * @see     LeapSeconds#isEnabled()
     */
