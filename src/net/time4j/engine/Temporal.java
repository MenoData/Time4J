 ...
 *
 * @param   <C> temporaler Vergleichstyp
...
public interface Temporal<C> {
     ...
     *
     * @param   temporal    Vergleichsobjekt
     * @return  {@code true} wenn diese Instanz zeitlich nach {@code temporal}
     ...
     *
     * @param   temporal    Vergleichsobjekt
     * @return  {@code true} wenn diese Instanz zeitlich vor {@code temporal}
     *          liegt, sonst {@code false}
     */
     ...
     *
     * @param   temporal    Vergleichsobjekt
     * @return  {@code true} wenn diese Instanz zeitlich gleich {@code temporal}
