...
public interface UnixTime {
     ...
     *
     * @return  Anzahl der Sekunden relativ zur UNIX-Epoche am 1. Januar 1970
     *          ohne UTC-Schaltsekunden in der UTC-Zeitzone (Greenwich)
     */
    long getPosixTime();
     ...
     * = 1 Sekunde). </p>
     *
     * @return  Zahl der Nanosekunden als Bruchteil der letzten Sekunde
     *          im Bereich {@code 0 - 999,999,999}
     */
    int getNanosecond();
