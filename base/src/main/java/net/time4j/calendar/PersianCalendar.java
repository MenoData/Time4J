 ...
 * <a href="http://www.astro.uni.torun.pl/~kb/Papers/EMP/PersianC-EMP.htm">The Persian calendar for 3000 years</a>.
 * beschreibt. Er ist in &Uuml;bereinstimmung mit dem bekannten Zyklus von Omar Khayam f&uuml;r die Jahre 1178-1633
 * (ISO: 1799-2254). Allerdings k&ouml;nnen Datumswerte nach dem gregorianischen Jahr 2123 falsch sein, weil der
...
public final class PersianCalendar
    ...
    /**
     * <p>Defines some calendar units for the Persian calendar. </p>
     *
     * @since   3.9/4.6
     */
    /*[deutsch]
