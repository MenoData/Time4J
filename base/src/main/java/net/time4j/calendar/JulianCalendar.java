...
public final class JulianCalendar
    ...
    public static final ChronoElement<Weekday> DAY_OF_WEEK =
        new StdWeekdayElement<>(JulianCalendar.class, getDefaultWeekmodel());

    private static final WeekdayInMonthElement<JulianCalendar> WIM_ELEMENT =
        new WeekdayInMonthElement<>(JulianCalendar.class, DAY_OF_MONTH, DAY_OF_WEEK);
     ...
     * @see     #of(HistoricEra, int, int, int)
     * @since   3.34/4.29
     */
    /*[deutsch]
