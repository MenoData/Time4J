...
public final class EthiopianCalendar
    ...
    public static final StdCalendarElement<EthiopianMonth, EthiopianCalendar> MONTH_OF_YEAR =
        new StdEnumDateElement<>("MONTH_OF_YEAR", EthiopianCalendar.class, EthiopianMonth.class, 'M');
    ...
    public static final ChronoElement<Evangelist> EVANGELIST =
        new StdEnumDateElement<>("EVANGELIST", EthiopianCalendar.class, Evangelist.class, '\u0000', "generic");
    ...
    private Object writeReplace() {
        ...
        return new SPXEthio(this, SPXEthio.DATE);
