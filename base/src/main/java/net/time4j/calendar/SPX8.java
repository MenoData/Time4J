 ...
 * -----------------------------------------------------------------------
 * This file (SPX8.java) is part of project Time4J.
 *
...
/**
 * <p>Serialisierungsform f&uuml;r den buddhistischen Sonnenkalender
 * von Thailand. </p>
 *
...
final class SPX8
    ...
    public void readExternal(ObjectInput in)
        ...
        if (header != THAI_SOLAR) {
            throw new InvalidObjectException("Unknown calendar type.");
        }
        
        PlainDate iso = PlainDate.class.cast(in.readObject());
        this.obj = iso.transform(ThaiSolarCalendar.class);
    }
