...
public final class HebrewCalendar
    ...
    public static final ChronoElement<HebrewEra> ERA =
        new StdEnumDateElement<>("ERA", HebrewCalendar.class, HebrewEra.class, 'G');
    ...
    public static final StdCalendarElement<Integer, HebrewCalendar> DAY_OF_MONTH =
        new StdIntegerDateElement<>("DAY_OF_MONTH", HebrewCalendar.class, 1, 30, 'd');
    ...
    public static final StdCalendarElement<Integer, HebrewCalendar> DAY_OF_YEAR =
        new StdIntegerDateElement<>("DAY_OF_YEAR", HebrewCalendar.class, 1, 355, 'D');
    ...
    public static final StdCalendarElement<Weekday, HebrewCalendar> DAY_OF_WEEK =
        new StdWeekdayElement<>(HebrewCalendar.class, getDefaultWeekmodel());

    private static final WeekdayInMonthElement<HebrewCalendar> WIM_ELEMENT =
        new WeekdayInMonthElement<>(HebrewCalendar.class, DAY_OF_MONTH, DAY_OF_WEEK);
    ...
    private static double hcMolad(
        ...
        long monthElapsed = m - 7 + Math.floorDiv(235 * y - 234, 19);
    ...
    private Object writeReplace() {
        ...
        return new SPXHebrew(this, SPXHebrew.DATE);
    ...
    private static class Transformer
        ...
        public HebrewCalendar transform(long utcDays) {
            ...
            int y = (int) Math.floorDiv(98496 * (fixedDays - FIXED_EPOCH), 35975351);
            int year = y - 1;
