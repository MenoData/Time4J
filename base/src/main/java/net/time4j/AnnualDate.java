...
public final class AnnualDate
    ...
    implements Comparable<AnnualDate>, Temporal<AnnualDate>, ThreetenAdapter, LocalizedPatternSupport, Serializable {
    ...
    /**
     * <p>Converts given JSR-310 type to an annual date. </p>
     *
     * @param   monthDay    JSR-310-equivalent
     * @return  corresponding annual date
     * @see     #toTemporalAccessor()
     */
    /*[deutsch]
     * <p>Konvertiert den angegebenen JSR-310-Typ zu einem Jahrestag. </p>
     *
     * @param   monthDay    JSR-310-equivalent
     * @return  corresponding annual date
     * @see     #toTemporalAccessor()
