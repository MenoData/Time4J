...
public class TimeScaleTest {
    ...
    public void transformTT() {
        Moment utc =
            PlainTimestamp.of(
                ...
                PlainTime.of(0, 0, 0, 999000000)
            ).inTimezone(ZonalOffset.UTC);
        assertThat(
            utc.transform(TimeScale.TT),
            is(new BigDecimal("31622445.183000000")));
        assertThat(
            Moment.of(31622445, 183000000, TimeScale.TT),
            is(utc));
        Moment ut =
            PlainTimestamp.of(
        ...
        assertThat(
            Moment.of(-31535959, 1000000000 - 728863512, TimeScale.TT),
            is(ut));
    }
    ...
    public void transformUT() {
        ...
        assertThat(
            Moment.of(31622400, 856857940, TimeScale.UT),
            is(utc));
        Moment ut =
    ...
    public void getNanosecondTT() {
        ...
        Moment m1972_a = PlainTimestamp.of(1972, 1, 1, 0, 0, 0).with(PlainTime.MILLI_OF_SECOND, 1).atUTC();
        Moment m1972_b = PlainTimestamp.of(1972, 1, 1, 0, 0, 0).with(PlainTime.MILLI_OF_SECOND, 987).atUTC();
        assertThat(m1971.getNanosecond(TimeScale.TT), is(282784289)); // approximation
        assertThat(m1972_a.getNanosecond(TimeScale.TT), is(185000000));
        assertThat(m1972_b.getNanosecond(TimeScale.TT), is(171000000));
    }
    ...
    public void getNanosecondUT() {
        Moment m1971 = PlainTimestamp.of(1971, 12, 31, 23, 59, 59).with(PlainTime.MILLI_OF_SECOND, 999).atUTC();
        Moment m1972 = PlainTimestamp.of(1972, 1, 1, 0, 0, 0).with(PlainTime.MILLI_OF_SECOND, 1).atUTC();
        assertThat(m1971.getNanosecond(TimeScale.UT), is(999000000));
        assertThat(m1972.getNanosecond(TimeScale.UT), is(898395543)); // approximation
    }
    ...
    public void toStringUT() {
        ...
        Moment ut2 = Moment.of(31622400, 813081576, TimeScale.UT); // 1973-01-01T00:00
        assertThat(
