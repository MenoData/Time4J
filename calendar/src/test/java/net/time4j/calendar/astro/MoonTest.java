...
public class MoonTest {
    ...
    public void moonlightHamburg() {
        ...
        assertThat(moonlight1.moonrise(),
            is(PlainTimestamp.of(1982, 9, 26, 15, 41, 59).in(tz)));
        assertThat(moonlight1.moonset(),
    ...
    public void moonlightMunich() {
        ...
        assertThat(moonlight.moonrise(), nullValue());
        assertThat(moonlight.moonset(),
    ...
    public void moonlightPolarCircle() { // see also: https://www.mooncalc.org
        ...
        assertThat(moonlight.moonrise(), nullValue());
        assertThat(moonlight.moonset(), nullValue());
        ...
        assertThat(moonlight2.moonrise(), nullValue());
        assertThat(moonlight2.moonset(), nullValue());
    ...
    public void moonlightNorthPole() {
        ...
        assertThat(moonlight1.moonrise(), is(PlainTimestamp.of(2017, 5, 22, 1, 29, 45).in(tz)));
        assertThat(moonlight1.moonset(), nullValue());
        ...
        assertThat(moonlight4.moonset(), is(PlainTimestamp.of(2017, 8, 24, 17, 59, 57).in(tz)));
        assertThat(moonlight4.moonrise(), nullValue());
        ...
        assertThat(moonlight6.moonset(), is(PlainTimestamp.of(2017, 9, 21, 2, 48, 18).in(tz)));
        assertThat(moonlight6.moonrise(), nullValue());
