...
public class AstroTest {
    ...
    public void williamsNewYork() { // see: http://www.edwilliams.org/sunrise_sunset_example.htm
        ...
        assertThat(
            ...
            is(0));
        assertThat(
            date.get(ny.sunrise()).toZonalTimestamp(tzid).toTime(),
            is(PlainTime.of(5, 26)));
        assertThat(
            date.get(ny.sunset()).toZonalTimestamp(tzid).toTime(),
    ...
    public void kilimanjaro() {
        ...
        SolarTime kiboSeaLevel =
            SolarTime.ofLocation()
                ...
                .build();
        assertThat(
            date.get(kiboSeaLevel.sunrise()).toZonalTimestamp(tzidObj).toTime(),
            is(PlainTime.of(6, 20, 13)));
        assertThat(
            date.get(kiboSeaLevel.sunset()).toZonalTimestamp(tzidObj).toTime(),
