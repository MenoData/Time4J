...
public class NengoTest {
    ...
    public void ofRelatedGregorianYear749() { // 749 has two nengos!
        ...
        assertThat(Nengo.ofRelatedGregorianYear(749).findPrevious().getFirstRelatedGregorianYear(), is(749));
    ...
    public void meiji() {
        ...
        assertThat(Nengo.MEIJI.findNext(), is(Nengo.TAISHO));
    ...
    public void taisho() {
        ...
        assertThat(Nengo.TAISHO.findNext(), is(Nengo.SHOWA));
    ...
    public void showa() {
        ...
        assertThat(Nengo.SHOWA.findNext(), is(Nengo.HEISEI));
    ...
    public void heisei() {
        ...
        assertThat(Nengo.HEISEI.findNext() != null, is(false));
    ...
    public void newest() {
        assertThat(
            ...
            is(true));
        List<Nengo> nengos = Nengo.list(Nengo.Selector.MODERN);
        assertThat(
            Nengo.NEWEST,
            is(nengos.get(nengos.size() - 1))); // last nengo
    }
