...
public class JapaneseElementTest {
    ...
    public void yearOfNengoElement() {
        ...
        assertThat(
            ...
            is(JapaneseCalendar.of(ansei.findNext(), 1, EastAsianMonth.valueOf(8), 29)));
        assertThat(
    ...
    public void weekdayInMonth() {
        JapaneseCalendar jcal = PlainDate.of(1872, 12, 31).transform(JapaneseCalendar.class); // Meiji-5(1872)-12-02
