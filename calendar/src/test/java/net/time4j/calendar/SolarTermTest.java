...
public class SolarTermTest {
    ...
    public void getSolarTerm() {
        assertThat(
            PlainDate.of(1989, 12, 21).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_11_DAXUE_255));
        assertThat(
            PlainDate.of(1989, 12, 22).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_11_DONGZHI_270));
        assertThat(
        ...
        assertThat(
            PlainDate.of(2018, 1, 4).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_11_DONGZHI_270));
        assertThat(
            PlainDate.of(2018, 1, 5).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_12_XIAOHAN_285));
        assertThat(
            PlainDate.of(2018, 1, 19).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_12_XIAOHAN_285));
        assertThat(
            PlainDate.of(2018, 1, 20).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_12_DAHAN_300));

        assertThat(
            PlainDate.of(2018, 2, 3).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_12_DAHAN_300));
        assertThat(
            PlainDate.of(2018, 2, 4).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_01_LICHUN_315));
        assertThat(
            PlainDate.of(2018, 2, 18).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_01_LICHUN_315));
        assertThat(
            PlainDate.of(2018, 2, 19).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_01_YUSHUI_330));

        assertThat(
            PlainDate.of(2018, 3, 4).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_01_YUSHUI_330));
        assertThat(
            PlainDate.of(2018, 3, 5).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_02_JINGZHE_345));
        assertThat(
            PlainDate.of(2018, 3, 20).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_02_JINGZHE_345));
        assertThat(
            PlainDate.of(2018, 3, 21).transform(ChineseCalendar.class).getSolarTerm(),
        ...
        assertThat(
            PlainDate.of(2018, 4, 4).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_02_CHUNFEN_000));
        assertThat(
            PlainDate.of(2018, 4, 5).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_03_QINGMING_015));
        assertThat(
            PlainDate.of(2018, 4, 19).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_03_QINGMING_015));
        assertThat(
            PlainDate.of(2018, 4, 20).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_03_GUYU_030));

        assertThat(
            PlainDate.of(2018, 5, 4).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_03_GUYU_030));
        assertThat(
            PlainDate.of(2018, 5, 5).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_04_LIXIA_045));
        assertThat(
            PlainDate.of(2018, 5, 20).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_04_LIXIA_045));
        assertThat(
            PlainDate.of(2018, 5, 21).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_04_XIAOMAN_060));

        assertThat(
            PlainDate.of(2018, 6, 5).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_04_XIAOMAN_060));
        assertThat(
            PlainDate.of(2018, 6, 6).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_05_MANGZHONG_075));
        assertThat(
            PlainDate.of(2018, 6, 20).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_05_MANGZHONG_075));
        assertThat(
            PlainDate.of(2018, 6, 21).transform(ChineseCalendar.class).getSolarTerm(),
        ...
        assertThat(
            PlainDate.of(2018, 7, 6).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_05_XIAZHI_090));
        assertThat(
            PlainDate.of(2018, 7, 7).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_06_XIAOSHU_105));
        assertThat(
            PlainDate.of(2018, 7, 22).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_06_XIAOSHU_105));
        assertThat(
            PlainDate.of(2018, 7, 23).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_06_DASHU_120));

        assertThat(
            PlainDate.of(2018, 8, 6).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_06_DASHU_120));
        assertThat(
            PlainDate.of(2018, 8, 7).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_07_LIQIU_135));
        assertThat(
            PlainDate.of(2018, 8, 22).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_07_LIQIU_135));
        assertThat(
            PlainDate.of(2018, 8, 23).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_07_CHUSHU_150));

        assertThat(
            PlainDate.of(2018, 9, 7).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_07_CHUSHU_150));
        assertThat(
            PlainDate.of(2018, 9, 8).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_08_BAILU_165));
        assertThat(
            PlainDate.of(2018, 9, 22).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_08_BAILU_165));
        assertThat(
            PlainDate.of(2018, 9, 23).transform(ChineseCalendar.class).getSolarTerm(),
        ...
        assertThat(
            PlainDate.of(2018, 10, 7).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_08_QIUFEN_180));
        assertThat(
            PlainDate.of(2018, 10, 8).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_09_HANLU_195));
        assertThat(
            PlainDate.of(2018, 10, 22).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_09_HANLU_195));
        assertThat(
            PlainDate.of(2018, 10, 23).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_09_SHUANGJIANG_210));

        assertThat(
            PlainDate.of(2018, 11, 6).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_09_SHUANGJIANG_210));
        assertThat(
            PlainDate.of(2018, 11, 7).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_10_LIDONG_225));
        assertThat(
            PlainDate.of(2018, 11, 21).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_10_LIDONG_225));
        assertThat(
            PlainDate.of(2018, 11, 22).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_10_XIAOXUE_240));

        assertThat(
            PlainDate.of(2018, 12, 6).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_10_XIAOXUE_240));
        assertThat(
            PlainDate.of(2018, 12, 7).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_11_DAXUE_255));
        assertThat(
            PlainDate.of(2018, 12, 21).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MINOR_11_DAXUE_255));
        assertThat(
            PlainDate.of(2018, 12, 22).transform(ChineseCalendar.class).getSolarTerm(),
            is(SolarTerm.MAJOR_11_DONGZHI_270));
        assertThat(
            AstronomicalSeason.WINTER_SOLSTICE
                .inYear(2018)
    ...
    public void format() throws ParseException {
        ChronoFormatter<ChineseCalendar> formatter =
            ChronoFormatter.setUp(ChineseCalendar.class, Locale.ENGLISH)
    ...
    public void onOrAfter() {
        ChineseCalendar date = PlainDate.of(2017, 12, 22).transform(ChineseCalendar.class);
        assertThat(
            SolarTerm.MAJOR_11_DONGZHI_270.onOrAfter(date),
            is(date));
        assertThat(
            SolarTerm.MAJOR_11_DONGZHI_270.onOrAfter(date.plus(CalendarDays.ONE)),
            is(PlainDate.of(2018, 12, 22).transform(ChineseCalendar.class)));
    }
